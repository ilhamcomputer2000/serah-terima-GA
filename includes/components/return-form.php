<div class="content-card bg-white p-6 rounded-xl shadow-sm">
    <h3 class="text-lg font-semibold text-gray-900 mb-4">Form Pengembalian</h3>
    <form id="returnForm" class="space-y-4" onsubmit="handleReturnSubmit(event)">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" name="returnDate" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Kondisi Barang</label>
                <select name="condition" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
